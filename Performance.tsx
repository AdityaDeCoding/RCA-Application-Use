              ...
              {activeTab === 'fitness' && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Input label="Pushups" value={fitnessForm.pushups} onChange={v => setFitnessForm({ ...fitnessForm, pushups: v })} />
                    <Input label="Squats" value={fitnessForm.squats} onChange={v => setFitnessForm({ ...fitnessForm, squats: v })} />
                    <Input label="Burpees" value={fitnessForm.burpees} onChange={v => setFitnessForm({ ...fitnessForm, burpees: v })} />
